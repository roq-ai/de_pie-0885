  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to de_pie - where influencers create, connect, and monetize. Publish newsletters, sell courses, or start engaging conversations in your community tab."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556764900-fa065610b0e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbmZsdWVuY2Vyc3xlbnwwfHx8fDE2OTQyMTcxNjR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@maddibazzocco?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Maddi Bazzocco`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to de_pie - where influencers create, connect, and monetize. Publish newsletters, sell courses, or start engaging conversations in your community tab.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Influencer" type="influencer" abilities={appConfig.ownerAbilities} />
