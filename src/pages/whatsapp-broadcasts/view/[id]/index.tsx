...
import { getWhatsappBroadcastById } from 'apiSdk/whatsapp-broadcasts';
import { WhatsappBroadcastInterface } from 'interfaces/whatsapp-broadcast';

function WhatsappBroadcastViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Whatsapp Broadcast Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('whatsapp_broadcast', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/whatsapp-broadcasts/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  label="Sent At"
                  text={data?.sent_at ? format(parseISO(data?.sent_at as unknown as string), 'dd-MM-yyyy') : ''}
                />
